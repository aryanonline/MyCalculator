...
equations. This calculator is an online claculator to help th user with being able to understand their math properly
...
calculations within simple calculator. User is able to select a genral form of a defined equation from graph. After
...
Use of selction structures like if and else statements, switch statements.
Use of diffrent types of repetition structures like for loops, while loops, and enhanced for loops,.
...
Use of static blocks that will be intialized first as soon as the class is initialized
